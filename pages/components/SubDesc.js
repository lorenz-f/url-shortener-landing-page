...
function SubDesc() {
  {/* component handling description underneath the link form */}
  return (
    <>
      <div className="flex flex-col h-[30.3vh] w-[32.5vw] mx-[auto] text-center ">
        <h1 className="text-5xl text-[#34313D] font-bold mt-24 pb-5">
          Advanced Statistics
        </h1>
        <p className="text-lg text-[#9E9AA8]">
          Track how your links are performing across the web with our advanced
          statistics dashboard.
        </p>
      </div>

      <div className="w-[86.4vw] h-[54.16vh] flex flex-col relative ">
        <div className="flex flex-row">
          <div className="flex flex-col h-[24.3vh] w-[28.8vw] ml-[11.8vw] bg-white p-10 ">
            <div className="absolute w-20 h-20 rounded-full bg-[#3A3054] top-[-40px] right-[69.35vw]" />
            <svg
            ...
            <h2 className="text-2xl text-[#34313D] font-bold py-5">
              Brand Recognition
            </h2>
            <p className="text-base text-[#9E9AA8]">
              {" "}
          ...
          <div className="text-[#2BD0D0] text-9xl font-bold absolute top-[9vh] left-[34.35vw]">
            -
          </div>
          <div className="flex flex-col h-[24.3vh] w-[28.8vw] ml-[3vw] mt-[4.07vh] bg-white p-10">
            <div className="absolute w-20 h-20 rounded-full bg-[#3A3054] top-[0] right-[43.55vw]" />
            <svg
          ...
          <div className="text-[#2BD0D0] text-9xl font-bold absolute top-[9vh] left-[60.2vw]">
            -
          </div>
          <div className="flex flex-col h-[24.3vh] w-[28.8vw] ml-[3vw] mt-[8.14vh] bg-white p-10">
            <div className="absolute w-20 h-20 rounded-full bg-[#3A3054] top-[36px] right-[17.4vw]" />
            <svg
